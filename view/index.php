...
<body class="min-h-screen flex flex-col items-center justify-center bg-gray-50 font-sans">

    <div class="artboard artboard-horizontal phone-5 bg-gray-100 rounded-lg shadow-2xl">
